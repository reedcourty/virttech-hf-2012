...
\todo{Forrás: \url{http://communities.vmware.com/docs/DOC-7390}}
...
\begin{table}[h]
	\caption{A disk.deviceLatency.average metrika}
	\centering
	\small
	\begin{tabular}{| p{3.5cm} | p{7.5cm} | p{2cm} |}
		\hline
	...
	\end{tabular}
	\normalsize
	\label{tab:disk.deviceLatency.average}
\end{table}

\begin{table}[h]
	\caption{A disk.kernelLatency.average metrika}
	\centering
	\small
	\begin{tabular}{| p{3.5cm} | p{7.5cm} | p{2cm} |}
		\hline
	...
	\end{tabular}
	\normalsize
	\label{tab:disk.kernelLatency.average}
\end{table}

\begin{table}[h]
	\caption{A disk.totallatency.average metrika}
	\centering
	\small
	\begin{tabular}{| p{3.5cm} | p{7.5cm} | p{2cm} |}
		\hline
