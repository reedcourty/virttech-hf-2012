...
INPUT_PATH <- file.path(BASE_PATH, "datas_wp")

# A kimeneti állományok ide fognak kerülni:
OUTPUT_PATH <- file.path(BASE_PATH, "output_wp")
...
LOG_FILE <- file.path(BASE_PATH, "metrics_cpu_wp.R.log")
...
vcdatas <- load_file(file.path(INPUT_PATH, "vcenter_datas_cleaned_wp.RData"))
